...
@section('content')
    ...
    <ul class="nav nav-tabs bg-light mt-3">
        <li class="nav-item">
          ...
          <li class="nav-item">
                <a class="nav-link  active" href="{{url('/admin/manage/feed/sell/sellBatchOrder/{$batch->batchOrder}')}}">批次信息</a>
        </li>
    </ul>
...
<h5 class="mt-2"> <small>本批次共有{{$batch->totalCattleNum}}头牛,详细如下表:</small></h5>
<table class="table table-bordered mt-2">
        <thead>
            <tr>
                    <th>序号</th>
