...
<div class="card rounded-0 my-3">
                ...
                <div class="card-body table-responsive">
                        <div class="card rounded-0 my-3">
                                ...
                                <div class="card-body ">
                                        <form action="/admin/manage/Veterinary/trim_hoof/store" method="post">
                                          {{csrf_field()}}
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="container disease_show" style="display:none;">
                                                      <div class="row">
                                                          <div class="col-lg-5 border border-warning mr-1">
                                                              ...
                                                              <div style="display:none;" class="form-group row">
                                                                ...
                                                                <div style="display:none;" class="form-group row">
                                                                  ...
                                                                  <div style="display:none;" class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                    <div class="custom-control custom-radio custom-control-inline">
                                                                      <input type="radio" id="status1" name="status" class="custom-control-input" value="ing" >
                                                                      <label class="custom-control-label" for="status1">蹄病需继续治疗</label>
                                                                    </div>
                                                                    <div class="custom-control custom-radio custom-control-inline">
                                                                      <input type="radio" id="status2" name="status" class="custom-control-input" value="done">
                                                          ...
                                                          <div class="col-lg-5 border border-warning ml-1">
                                                              <div class="form-row justify-content-center">
                                                                  <div class="alert alert-info alert-rounded text-center w-50" role="alert">
                                                          ...
                                                          <div class="col-lg-5 border border-warning mt-1 mr-1">
                                                              <div class="form-row justify-content-center">
                                                              <div class="alert alert-info alert-rounded text-center w-50" role="alert">
                                                              ...
                                                              <div style="display:none;" class="form-group row">
                                                                ...
                                                                <div style="display:none;" class="form-group row">
                                                                    ...
                                                                    <div style="display:none;" class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input" name="therapeuticway[]" type="checkbox" id="LB_therap1" value="药物治疗">
                                                                                <label class="form-check-label" for="LB_therap1">药物治疗</label>
                                                                              </div>
                                                                              <div class="form-check form-check-inline">
                                                                                <input class="form-check-input" name="therapeuticway[]" type="checkbox" id="LB_therap2" value="输液">
                                                                                <label class="form-check-label" for="LB_therap2">输液</label>
                                                                              </div>
                                                                              <div class="form-check form-check-inline">
                                                                                <input class="form-check-input" name="therapeuticway[]" type="checkbox" id="LB_therap3" value="穿刺手术" >
                                                                                <label class="form-check-label" for="LB_therap3">穿刺手术</label>
                                                                              </div>
                                                                              <div class="form-check form-check-inline">
                                                                                  <input class="form-check-input" name="therapeuticway[]" type="checkbox" id="LB_therap4" value="封闭疗法" >
                                                                                  <label class="form-check-label" for="LB_therap4">封闭疗法</label>
                                                                                </div>
                                                                                <div class="form-check form-check-inline">
                                                                                    <input class="form-check-input" name="therapeuticway[]" type="checkbox" id="LB_therap5" value="瘤胃内容物疗法" >
                                                                                    <label class="form-check-label" for="LB_therap5">瘤胃内容物疗法</label>
                                                                                  </div>
                                                                                  <div class="form-check form-check-inline">
                                                                                      <input class="form-check-input" name="therapeuticway[]" type="checkbox" id="LB_therap6" value="腹膜透析疗法" >
                                                                                      <label class="form-check-label" for="LB_therap6">腹膜透析疗法</label>
                                                                                    </div>
                                                                                    <div class="form-check form-check-inline">
                                                                                        <input class="form-check-input" name="therapeuticway[]" type="checkbox" id="LB_therap7" value="灌肠法和破解术" >
                                                                                        <label class="form-check-label" for="LB_therap7">灌肠法和破解术</label>
                                                                                      </div>
                                                                                      <div class="form-check form-check-inline">
                                                                                          <input class="form-check-input" name="therapeuticway[]" type="checkbox" id="LB_therap8" value="冲洗法" >
                                                                                          <label class="form-check-label" for="LB_therap8">冲洗法</label>
                                                                                        </div>
                                                                                        <div class="form-check form-check-inline">
                                                                                            <input class="form-check-input" name="therapeuticway[]" type="checkbox" id="LB_therap9" value="物理疗法" >
                                                                                            <label class="form-check-label" for="LB_therap9">物理疗法</label>
                                                                                          </div>
                                                                                          <div class="form-check form-check-inline">
                                                                                              <input class="form-check-input" name="therapeuticway[]" type="checkbox" id="LB_therap10" value="其它" >
                                                                  ...
                                                                  <div style="display:none;" class="form-group row" id="LB_selectDrug" hidden>
                                                                      ...
                                                                      <input type="hidden" class="LB_drug_id" name="LB_drug_id">
                                                                      <div class="col-sm-3 mt-1">
                                                                        ...
                                                                        <div class="input-group mt-1 col-sm-3 my-1">
                                                                          ...
                                                                          <div class="input-group-prepend">
                                                                            <div class="input-group-text LB_input_unit">ml</div>
                                                                          </div>
                                                                          </div>
                                                                  ...
                                                                  <div style="display:none;" class="form-group row">
                                                                      <label for="LB_note" class="col-sm-3 col-form-label">治疗方案附加说明（非必填）</label>
                                                                      <div class="col-sm-9">
                                                          ...
                                                          <div class="col-lg-5 border border-warning mt-1 ml-1">
                                                              <div class="form-row justify-content-center">
                                                              <div class="alert alert-info alert-rounded text-center w-50" role="alert">
                                                              ...
                                                              <div style="display:none;" class="form-group row">
                                                                ...
                                                                <div style="display:none;" class="form-group row">
                                                                      ...
                                                                      <div class="col-sm-9">
                                                                              <textarea  class="form-control" id="RB_diseaseCondition" name="RB_diseaseCondition" placeholder="保健修蹄可以写无"></textarea>
                                                                      </div>
                                                                    </div>
                                                                    <div style="display:none;" class="form-group row">
                                                                  ...
                                                                  <div style="display:none;" class="form-group row" id="RB_selectDrug" hidden>
                                                                      <label for="drugUse" class="col-sm-3 col-form-label">选择使用的药物</label>
                                                                      <input type="hidden" class="RB_drug_id" name="RB_drug_id">
                                                                      <div class="col-sm-3 mt-1">
                                                                        ...
                                                                        <div class="input-group mt-1 col-sm-3 my-1">
                                                                          ...
                                                                          <div class="input-group-prepend">
                                                                            <div class="input-group-text RB_input_unit">ml</div>
                                                                          </div>
                                                                          </div>
                                                                  ...
                                                                  <div style="display:none;" class="form-group row">
                                                                      <label for="RB_note" class="col-sm-3 col-form-label">治疗方案附加说明（非必填）</label>
                                                                      <div class="col-sm-9">
                                                                  ...
                                                                  <div style="display:none;" class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                    <div class="custom-control custom-radio custom-control-inline">
                                                                      <input type="radio" id="RB_status1" name="status" class="custom-control-input" value="ing" >
                                                                      <label class="custom-control-label" for="RB_status1">蹄病需继续治疗</label>
                                                                    </div>
                                                                    <div class="custom-control custom-radio custom-control-inline">
                                                                      <input type="radio" id="RB_status2" name="status" class="custom-control-input" value="done">
                                  ...
                                  <div class="d-flex justify-content-center">
                                        <button type="submit" class="btn btn-outline-success justify-content-end">提交</button>
                                      </div>
                                  </div>
                                </form>
                  </div>
