                ...
                <div class="card-body table-responsive">
                    ...
                    <form action="#">
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                                <label for="date" class="col-sm-2 col-form-label">消毒日期</label>
                                <div class="col-sm-10">
                          ...
                          <div class="form-group row">
                            <label for="manufacturers" class="col-sm-2 col-form-label">消毒药品</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="manufacturers"  name="manufacturers">
                            </div>
                          </div>
                          <div class="form-group row">
                                <label for="manufacturers" class="col-sm-2 col-form-label">药品稀释比例</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="manufacturers"  name="manufacturers">
                                </div>
                              </div>
